<h1 align="center">Welcome to dumpDiskInfo 👋</h1>
<p>
...
> A simple script that dumps information about the OS and disk to a file in /root

## What is the project?

dumpDiskInfo.sh is a simple script that fetches OS and disk info from common utility programs and dumps this info to a text file with headings separating the information for easy reading later.

## What is the MVP?

The minimal valuable product is a script that successfully and automatically fetches the information while providing feedback to the user. 
...
The project will be complete once the script is usable to obtain and dump the info.
